...
BTN_QUICK_START = "Быстрый старт"
BTN_TOPIC_TEST = "Тест по теме"
...
NO_MISTAKES = (
    ...
    "Сначала пройди «Быстрый старт» или «Тест по теме» — "
    "потом сможешь поработать над ошибками."
)
...
ABOUT = (
    ...
    "о туризме и гостеприимстве.\n\n"
    "<b>Режимы:</b>\n"
    "• «Быстрый старт» — 10 случайных вопросов из всех тем.\n"
    "• «Тест по теме» — выбираешь конкретную тему, 10 вопросов по ней.\n"
    "• «Работа над ошибками» — вопросы, в которых ты ошибался "
    "(уходят из списка, как только ответишь на них правильно).\n\n"
    "Варианты ответов в каждом вопросе перемешиваются — "
    "порядок A/B/C/D каждый раз новый.\n\n"
